...
map_param_query <- tibble::tribble(
  ...
  # Electricity
  "electricity","elecByTechTWh", c("elec gen by gen tech and cooling tech"),"pal_hot","no",
  "electricity","elecConsumByDemandSectorTWh", "elec consumption by demand sector", "pal_hot", "no",
  "electricity", "elecPricesBySector", "elec prices by sector", "pal_hot", "no",
  # Energy
  ...
  "energy","energyFinalByFuelEJNoFeedstock", "final energy consumption by sector and fuel", "pal_hot", "no",
  "energy","energyFinalByFuelEJ", "final energy consumption by sector and fuel","pal_hot","no",
  ...
  "energy","energyFinalByTechTransportPassEJ", "transport final energy by tech and fuel", "pal_hot", "no",
  "energy","energyFinalByTechTransportFreightEJ", "transport final energy by tech and fuel", "pal_hot", "no",
  # Outputs
  "outputs","transportPassengerVMTByMode", "transport service output by mode","pal_hot","no",
  "outputs","transportFreightVMTByMode", "transport service output by mode","pal_hot","no",
  "outputs","transportPassengerVMTByFuel","transport service output by tech","pal_hot","no",
  "outputs","transportFreightVMTByFuel", "transport service output by tech","pal_hot","no",
  "outputs","transportPassengerVMTByTech", "transport service output by tech", "pal_hot", "no",
  "outputs","transportFreightVMTByTech", "transport service output by tech", "pal_hot", "no",
  "outputs","serviceOutputByTechBuildingsResid", "building service output by tech", "pal_hot", "no",
  "outputs","serviceOutputByTechBuildingsComm", "building service output by tech", "pal_hot", "no",
  # Socio-economics
  ...
  "socioecon","buildingFloorspace", "building floorspace", "pal_hot", "no",
  # Emissions
