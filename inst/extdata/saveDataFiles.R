...
map_param_query <- tibble::tribble(
  ...
  # Emissions
  "emissions","emissGHGBySectorGWPAR5", c("nonCO2 emissions by sector", "nonCO2 emissions by resource production", "Land Use Change Emission (future)", "CO2 sequestration by sector"),"pal_hot","no",
  "emissions","emissGHGByGasGWPAR5", c("nonCO2 emissions by sector", "nonCO2 emissions by resource production", "Land Use Change Emission (future)", "CO2 sequestration by sector"),"pal_hot","no",
