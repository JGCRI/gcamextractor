...
map_param_query <- tibble::tribble(
  ...
  "emissions", "emissCO2IndirectNoBio", c("CO2 emissions by sector (no bio)", "CO2 sequestration by sector", "Land Use Change Emission (future)", "CO2 emissions by tech", "energy consumption by tech", "outputs by tech", "prices of all markets", "CO2 sequestration by tech"),"pal_hot","no",
