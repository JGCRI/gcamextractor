...
dataGCAM <- gcamextractor::readgcam(gcamdatabase = Path_to_GCAMdatabase,
                                    ...
                                    paramsSelect = "pop")  # Set to "All" to read in all available params
...
Use the `cerf` for the parameter argument in `gcamextractor` to extract the relevant variables needed for the `CERF` model (https://github.com/IMMM-SFA/cerf).
...
* gcam_to_cerf_tech_name_map
* lifetime_yr
* capacity_factor
* variable_cost_esc_rate_fraction
* fuel_esc_rate_fraction
* variable_om_USDperMWh
* heat_rate_BTUperkWh
* fuel_price_USDperGJ
* carbon_capture_rate_fraction
* fuel_co2_content_tonsperMWh
* carbon_esc_rate_fraction
* carbon_tax_USDperTon
* New capacity by vintage
* Retired capacity by vintage
