      ...
      tbl <- tbl %>%
        ...
        dplyr::mutate(param = "energyFinalConsumBySecEJ",
                      ...
                      class1 = dplyr::case_when(
                        ...
                        grepl("industry|alumin|iron and steel",sector)~"industry",
                        grepl("transport",sector)~"transport",
                        grepl("agricultural energy use|municipal|irrigation water abstraction", sector)~"other"),
                      classLabel1 = "Sector",
                      classPalette1 = "pal_all",
                      class2 = sector,
                      classLabel2 = "Subsector",
    ...
    if (queryx %in% queriesx) {
      ...
      tbl <- tbl %>%
        ...
        dplyr::mutate(input=dplyr::if_else(input=="biomass","bioenergy",input),
                      ...
                      sector=replace(sector, stringr::str_detect(sector, "H2"), "hydrogen"),
