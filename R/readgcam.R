    ...
    if (queryx %in% queriesx) {
      ...
      tbl <- tbl %>%
        ...
        dplyr::mutate(param = "energyPrimaryByFuelEJ",
                      fuel=gsub("biomass","d bioenergy",fuel),
                      fuel=gsub("b biomass","d bioenergy",fuel),
                      fuel=gsub("traded coal","c coal",fuel),
                      fuel=gsub("traded natural gas","b natural gas",fuel),
                      fuel=gsub("traded oil","a oil",fuel),
                      fuel=gsub("regional bioenergy","d bioenergy",fuel),
                      fuel=gsub("H2 industrial","k hydrogen",fuel),
                      sources = "Sources",
                      origScen = scenario,
                      origQuery = queryx,
                      origValue = value,
